 ...
 *	La clase "item.class.php" es la clase del modelo, que representa a un item de la tabla
*/
require_once  __DIR__ . '/../src/utils/response.php';
require_once __DIR__ . '/../src/classes/auth.class.php';
require_once __DIR__ . '/../src/classes/plans.class.php';
...
switch ($_SERVER['REQUEST_METHOD']) {
	...
	/**
	 * Cuando es PUT, comprobamos si la petición lleva el id del item que hay que actualizar. En caso afirmativo se usa el método update() del modelo.
...
/**
	...
	/**
	 * Cuando se solicita un DELETE se comprueba que se envíe un id de item. En caso afirmativo se utiliza el método delete() del modelo.
	 */
	case 'DELETE':

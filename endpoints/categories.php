<?php
/**
 * Script que se usa en los endpoints para trabajar con registros de la tabla categories
 * La clase "categories.class.php" es la clase del modelo, que representa a un item de la tabla
*/
require_once  __DIR__ . '/../src/utils/response.php';
require_once __DIR__ . '/../src/classes/auth.class.php';
require_once __DIR__ . '/../src/classes/categories.class.php';

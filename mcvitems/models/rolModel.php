...
// Clase del modelo para trabajar con la tabla ROLES
class RolModel
{
    ...
    public function getAll() {
        session_start();
        $curl = curl_init($this->url_apirest. "roles.php");
    ...
    public function insert(){
        session_start();
        $ch = curl_init($this->url_apirest.'roles.php');
    ...
    public function delete($id){
        session_start();
        $ch = curl_init($this->url_apirest. "roles.php?id_rol=". $id);
        curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
